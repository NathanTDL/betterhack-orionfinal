    ...
    <section className="flex flex-col items-center justify-center px-4 mb-24 w-full">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold tracking-tight mb-4">
          Choose Your Ark Plan
        </h1>
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Start capturing your life with AI-powered organization. Upgrade anytime as your vault grows.
        </p>
      </div>

      <div className="grid md:grid-cols-2 gap-8 max-w-4xl w-full">
        {/* Starter Tier */}
        <Card className="relative h-fit border-2 hover:border-cyan-500/50 transition-all">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span>Unlimited notes & links</span>
            </div>
            <div className="flex items-center gap-3">
              <Check className="h-5 w-5 text-cyan-500" />
              <span>10GB media storage</span>
            </div>
            <div className="flex items-center gap-3">
              <Check className="h-5 w-5 text-cyan-500" />
      ...
      <div className="mt-12 text-center">
        <p className="text-muted-foreground">
          ...
          <span className="text-cyan-600 cursor-pointer hover:underline font-medium">
            Contact support
          </span>
        </p>
      </div>
